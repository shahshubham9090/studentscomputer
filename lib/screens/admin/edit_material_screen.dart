...
class _EditMaterialScreenState extends State<EditMaterialScreen> {
  ...
  void initState() {
    super.initState();
    // Pre-populate form fields with existing material data
    ...
    _uploadedQuestions = widget.material.questions;
  }
  ...
  Future<void> _updateMaterial() async {
    ...
    try {
      ...
      await context.read<MaterialProvider>().updateMaterial(updatedMaterial);

      if (mounted) {
        AppFeedback.showSuccess("Material updated successfully!");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Material', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        elevation: 0,
        actions: [
          IconButton(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: const Text('Update Material', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ),
